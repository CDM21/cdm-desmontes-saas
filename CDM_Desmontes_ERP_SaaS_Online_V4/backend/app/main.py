...
from .routers import auth, vehicles, products, sales, finance, stock, marketplaces, company, catalog, billing

Base.metadata.create_all(bind=engine)

app = FastAPI(title="CDM Desmontes ERP API", version="4.0.0")
...
@app.get("/api/health")
def health():
    return {"status":"ok","service":"cdm-desmontes-erp","version":"4.0.0"}
